...
import { isBashBuiltinVariable } from './bash-builtin-variables'
 ...
 *
 * Bash builtin/special variables (PWD, BASH_SOURCE, RANDOM, LINENO, etc.)
 * are NOT resolved via process.env — they are dynamically generated by bash
 * and the host process environment is not a valid fallback.
 *
...
export function resolveFlowVariable(
  ...
  // Never fall back to process.env for bash builtin/special variables.
  // These are dynamically generated by bash (e.g. RANDOM, LINENO), reflect
  // internal shell state (e.g. BASH_SOURCE, FUNCNAME), or are positional
  // parameters — none of which appear in the environment by default.
